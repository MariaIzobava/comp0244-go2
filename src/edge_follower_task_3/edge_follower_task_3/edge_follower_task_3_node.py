...
class EdgeFollowerNode(Node):
    def __init__(self):
        ...
        # Publishers
        self.waypoint_pub = self.create_publisher(Pose2D, '/edge_waypoint', 10)
    ...
    def timer_callback(self):
        ...
        if next_waypoint is not None:
            ...
            self.get_logger().info(f"Published EDGE_FOLLOWER waypoint: x={waypoint_msg.x}, y={waypoint_msg.y}")
        else:
            self.get_logger().warn("No valid EDGE_FOLLOWER waypoint computed!")
